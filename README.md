...
This GitHub Actions workflow is designed to be **reusable** across multiple Node.js/PHP projects. It creates a zip package of the project and publishes a GitHub release.

## Features

- Checkout project code.
- Install Node.js and Composer dependencies.
- Build the project (`npm run build` if present).
- Create a zip package of the project.
- Upload the artifact for use in subsequent jobs.
